...
const IrregularVerbsPracticePage = () => {
  ...
  const { irregularVerbs, irregularVerbsLoading } = useAppSelector(
    (state) => state.irregularVerbReducer
  )
  ...
  const filteredVerbs =
    selectedLevel === "all"
      ...
      : irregularVerbs.filter(
          (verb) => verb.level.toLowerCase() === selectedLevel.toLowerCase()
        )
  ...
  const selectRandomVerb = () => {
    const availableVerbs = filteredVerbs.filter(
      (verb: IIrregularVerbDto) => !practicedVerbs.has(verb.irregularVerbId)
    )
  ...
  const handleSubmit = () => {
    ...
    const isV2Correct =
      v2Input.trim().toLowerCase() === currentVerb.v2.toLowerCase()
    const isV3Correct =
      v3Input.trim().toLowerCase() === currentVerb.v3.toLowerCase()
    ...
    if (isV2Correct && isV3Correct) {
      ...
      setPracticedVerbs(
        (prev) => new Set(Array.from(prev).concat(currentVerb.irregularVerbId))
      )
            ...
            <div className="mb-6 text-center">
              ...
              <div className="w-full bg-pink-200 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{
                    width: `${
                      (practicedVerbs.size / filteredVerbs.length) * 100
                    }%`,
                  }}
                ></div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <button
                    ...
                    disabled={
                      !v2Input.trim() || !v3Input.trim() || isCorrect === true
                    }
